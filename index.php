...
<body>
            ...
            <div class="col-lg-9">
                <nav class="navbar navbar-expand-sm bg-dark p-0">
                    <ul class="navbar-nav ml-n2">
                        ...
                        <li class="nav-item border-right border-secondary">
                            <a class="nav-link text-body small" href="#">Suggestions & FAQs</a>
                        </li>
                ...
                <div class="navbar-nav mr-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu rounded-0 m-0">
                            <a href="registrationDivyangjan.html" class="dropdown-item">Registration as a Divyangjan</a>
                        ...
                        <!-- <div class="position-relative overflow-hidden" style="height: 250px;"> -->
                            <!-- <div class="card" style="width: 18rem;">
                                <ul class="list-group list-group-flush">
                                  <li class="list-group-item">Cras justo odio Lorem, ipsum dolor.</li>
                                  <li class="list-group-item">Cras justo odio Lorem, ipsum dolor.</li>
                                  <li class="list-group-item">Cras justo odio Lorem, ipsum dolor.</li>
                                  <li class="list-group-item">Cras justo odio Lorem, ipsum dolor.</li>
                                  <li class="list-group-item">Cras justo odio Lorem, ipsum dolor.</li>
            ...
            <div class="row align-items-center bg-dark">
                <div class="col-12">
                    <div class="d-flex justify-content-between">
                        <div class="bg-primary text-dark text-center font-weight-medium py-2" style="width: 170px;">Latest Update</div>
                        <div class="owl-carousel tranding-carousel position-relative d-inline-flex align-items-center ml-3"
                            style="width: calc(100% - 170px); padding-right: 90px;">
                            <div class="text-truncate"><a class="text-white text-uppercase font-weight-semi-bold" href="">Unique ID for Persons with Disabilities” project is being implemented with a view of creating a National Database for PwDs,</a></div>
                            <div class="text-truncate"><a class="text-white text-uppercase font-weight-semi-bold" href="">Lorem ipsum dolor sit amet elit. Proin interdum helo fun eas lacus eget ante tincidunt  .</a></div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container-fluid pt-5 mb-3">
        <div class="container">
            <div class="section-title">
                <h4 class="m-0 text-uppercase font-weight-bold">Schemes Run by Government</h4>
            </div>
            <div class="owl-carousel news-carousel carousel-item-4 position-relative">
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    ...
                    <div class="overlay">
                        ...
                        <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">Early Intervention and School Readiness Scheme</a>
                    </div>
                </div>
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    ...
                    <div class="overlay">
                        ...
                        <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">Day Care</a>
                    </div>
                </div>
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    ...
                    <div class="overlay">
                        ...
                        <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">Respite Care</a>
                    </div>
                </div>
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    ...
                    <div class="overlay">
                        ...
                        <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">Group Home for Adults</a>
                    </div>
                </div>
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    ...
                    <div class="overlay">
                        <div class="mb-2">
                            <a class="badge badge-primary text-uppercase font-weight-semi-bold p-2 mr-2"
                                href=""> NIRAMAYA SAHYOGI</a>
                            <!-- <a class="text-white" href=""><small>Jan 01, 2045</small></a> -->
                        </div>
                        <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href="">Caregiver training scheme</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111;">
        <p class="m-0 text-center">&copy; <a href="index.html">Rastriya Seva Portal</a>. All Rights Reserved. 
